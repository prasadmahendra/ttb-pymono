...
from treasury.services.gateways.ttb_api.main.application.models.domain.label_approval_job import LabelApprovalStatus, AnalysisMode
...
class JobMetadataInput:
    ...
    analysis_mode: Optional[AnalysisMode] = AnalysisMode.using_llm  # analysis mode: using_llm or pytesseract
